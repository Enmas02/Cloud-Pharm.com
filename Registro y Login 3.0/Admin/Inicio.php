...
.main_container .container .item .titulo{
...
<div class="wrapper">
  ...
  <div class="main_container">
      ...
      <div class="item">
          <center><h2>Bienvenido/a. <span class="titulo"><?php echo $_SESSION['nombre'];?></span></h2></center>
        </div>

      <div class="item">
          Estimado usuario, queremos darte la bienvenida a nuestra aplicación web. Nuestro sistema gestor de farmacia te permitirá, manejar tu farmacia de una manera nunca antes vista.
        </div>
        ...
        <div class="box">
          <div class="icon" aria-hidden="true"><i class="fas fa-user-friends"></i></div>
        </div>
