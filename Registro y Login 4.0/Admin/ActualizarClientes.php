		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				...
				<p class="text-justify">
					Bienvenid@ <?php echo $_SESSION['nombre'];?>, Estás en los clientes, nuestro sistema gestor de farmacia está aquí para hacerte la vida más comoda, aquí puedes insertar clientes y también ver los clientes.
				</p>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="Cliente.php"><i class="fas fa-plus"></i> &nbsp; Nuevo Cliente</a>
					</li>
					<li>
						<a href="VerClientes.php"><i class="fas fa-tasks"></i> &nbsp; Ver Clientes</a>
					</li>
				</ul>	
			</div>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="../php/ActualizarCliente.php" method="GET" class="form-neon" autocomplete="off">
					<fieldset>
							...
							<input type="hidden" name="id" value="<?php echo $filas['ID']?>">
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" value="<?php echo $filas['Nombre']?>" required name="nombre" pattern="[a-zA-Z0-9]{1,25}" class="form-control" id="ProductCode" maxlength="25">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductName" class="bmd-label-floating">Apellido</label>
										<input type="text" value="<?php echo $filas['Apellido']?>" required name="apellido" pattern="[a-zA-Z0-9 ]{1,30}" class="form-control" id="ProductName" maxlength="30">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProductBrand" class="bmd-label-floating">Dirección</label>
										<input type="text" value="<?php echo $filas['Direccion']?>" required name="direccion" pattern="[a-zA-Z0-9]{1,25}" class="form-control" id="ProductBrand" maxlength="25">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProductModel" class="bmd-label-floating">Teléfono</label>
										<input type="num" value="<?php echo $filas['Telefono']?>" required name="telefono" pattern="[a-zA-z0-9 ]{1,20}" class="form-control" id="ProductModel" maxlength="20">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProducPrice" class="bmd-label-floating">Fecha de Pedido</label>
										<input type="date" value="<?php echo $filas['Fecha_Pedido']?>" required name="fechapedido" pattern="[0-9.]{1,15}" class="form-control" id="ProducPrice" maxlength="15">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductCode" class="bmd-label-floating">Vendedor</label>
										<input type="text" value="<?php echo $filas['Vendedor']?>" required name="vendedor" pattern="[a-zA-Z0-9]{1,25}" class="form-control" id="ProductCode" maxlength="25">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductName" class="bmd-label-floating">Crédito</label>
										<input type="num" value="<?php echo $filas['Credito']?>" required name="credito" pattern="[a-zA-Z0-9 ]{1,30}" class="form-control" id="ProductName" maxlength="30">
									</div>
								</div>
							</div>
						</div>
