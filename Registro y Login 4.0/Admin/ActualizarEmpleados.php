...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="../php/ActualizarEmpleado.php" method="GET" class="form-neon" autocomplete="off">
					<fieldset>
							...
							<div class="row">
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="number" value="<?php echo $filas['Telefono']?>" required name="telefono" pattern="[a-zA-z0-9 ]{1,20}" class="form-control" id="ProductModel" maxlength="20">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProducPrice" class="bmd-label-floating">Fecha de nacimiento</label>
										<input type="date" value="<?php echo $filas['Fecha_Nacimiento']?>" required name="fechanacimiento" pattern="[0-9.]{1,15}" class="form-control" id="ProducPrice" maxlength="15">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductCode" class="bmd-label-floating">Salario</label>
										<input type="number" value="<?php echo $filas['Salario']?>" required name="salario" pattern="[a-zA-Z0-9]{1,25}" class="form-control" id="ProductCode" maxlength="25">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductName" class="bmd-label-floating">Departamento</label>
										<input type="text" value="<?php echo $filas['Departamento']?>" required name="departamento" pattern="[a-zA-Z0-9 ]{1,30}" class="form-control" id="ProductName" maxlength="30">
									</div>
								</div>
							</div>
						</div>
