		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				...
				<p class="text-justify">
					Bienvenid@ <?php echo $_SESSION['nombre'];?>, Estás en los productos, nuestro sistema gestor de farmacia está aquí para hacerte la vida más comoda, aquí puedes insertar productos y también ver los productos.
				</p>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="Productos.php"><i class="fas fa-plus"></i> &nbsp; Nuevo Producto</a>
					</li>
					<li>
						<a href="VerProductos.php"><i class="fas fa-tasks"></i> &nbsp; Ver Productos</a>
					</li>
				</ul>	
			</div>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="../php/ActualizarProducto.php" method="GET" class="form-neon" autocomplete="off">
					<fieldset>
						<legend><i class="fas fa-box-open"></i> &nbsp; Información</legend>
						<div class="container-fluid">
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductName" class="bmd-label-floating">Concentración</label>
										<input type="text" value="<?php echo $filas['concentracion']?>" required name="concentracion" pattern="[a-zA-Z0-9 ]{1,30}" class="form-control" id="ProductName" maxlength="30">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProductBrand" class="bmd-label-floating">Fabricante</label>
										<input type="text" value="<?php echo $filas['fabricante']?>" required name="fabricante" pattern="[a-zA-Z0-9]{1,25}" class="form-control" id="ProductBrand" maxlength="50">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProductModel" class="bmd-label-floating">Presentación Disponible</label>
										<input type="text" value="<?php echo $filas['presentacion_disponible']?>" required name="presentacion" pattern="[a-zA-z0-9 ]{1,20}" class="form-control" id="ProductModel" maxlength="50">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProducPrice" class="bmd-label-floating">Precio</label>
										<input type="num" value="<?php echo $filas['precio']?>" required name="precio" pattern="[0-9.]{1,15}" class="form-control" id="ProducPrice" maxlength="30">
									</div>
								</div>
							</div>
						</div>
