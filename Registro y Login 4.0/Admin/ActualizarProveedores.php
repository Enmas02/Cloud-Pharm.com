	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-truck-moving fa-fw"></i> &nbsp; Proveedores
				</h3>
				<p class="text-justify">
					Bienvenid@ <?php echo $_SESSION['nombre'];?>, Estás en los proveedores, nuestro sistema gestor de farmacia está aquí para hacerte la vida más comoda, aquí puedes insertar proveedores y también ver los proveedores.
				</p>
			</div>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="Proveedor.php"><i class="fas fa-plus"></i> &nbsp; Nuevo Proveedor</a>
					</li>
					<li>
						<a href="VerProveedores.php"><i class="fas fa-tasks"></i> &nbsp; Ver Proveedores</a>
					</li>
				</ul>	
			</div>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="../php/ActualizarProveedor.php" method="GET" class="form-neon" autocomplete="off">
					<fieldset>
						<legend><i class="fas fa-truck-moving fa-fw"></i> &nbsp; Información</legend>
						<div class="container-fluid">
							<div class="row">
								<input type="hidden" name="id" value="<?php echo $filas['ID']?>">
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductCode" class="bmd-label-floating">Proveedor</label>
										<input type="text" value="<?php echo $filas['Proveedor']?>" required name="proveedor" pattern="[a-zA-Z0-9]{1,25}" class="form-control" id="ProductCode" maxlength="25">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductName" class="bmd-label-floating">Empresa</label>
										<input type="text" value="<?php echo $filas['Empresa']?>" required name="empresa" pattern="[a-zA-Z0-9 ]{1,30}" class="form-control" id="ProductName" maxlength="30">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProductBrand" class="bmd-label-floating">Contacto</label>
										<input type="text" value="<?php echo $filas['Contacto']?>" required name="contacto" pattern="[a-zA-Z0-9]{1,25}" class="form-control" id="ProductBrand" maxlength="25">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProductModel" class="bmd-label-floating">Dirección</label>
										<input type="text" value="<?php echo $filas['Direccion']?>" required name="direccion" pattern="[a-zA-z0-9 ]{1,20}" class="form-control" id="ProductModel" maxlength="20">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProducPrice" class="bmd-label-floating">Teléfono</label>
										<input type="num" value="<?php echo $filas['Telefono']?>" required name="telefono" pattern="[0-9.]{1,15}" class="form-control" id="ProducPrice" maxlength="15">
									</div>
								</div>
							</div>
						</div>
