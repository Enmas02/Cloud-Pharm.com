...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<!-- Content -->
			<div class="container-fluid">
				<form action="../php/ActualizarUsuario.php" method="GET" class="form-neon" autocomplete="off">
					<fieldset>
...
$rfoto = $_FILES['avatar-file']['tmp_name'];
...
$sqli = "UPDATE registro SET Imagen = '$destino' WHERE id = '$id'";
$queryi = mysqli_query($conexion, $sqli);
