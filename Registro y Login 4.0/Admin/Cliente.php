...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="../php/AgregarCliente.php" method="POST" class="form-neon" autocomplete="off">
					<fieldset>
							...
							<div class="row">
								...
								<div class="col-12 col-md-4">
									<div class="form-group">
										...
										<input type="num" required name="telefono" pattern="[a-zA-z0-9 ]{1,20}" class="form-control" id="ProductModel" maxlength="20">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProducPrice" class="bmd-label-floating">Fecha de Pedido</label>
										<input type="date" required name="fechapedido" pattern="[0-9.]{1,15}" class="form-control" id="ProducPrice" maxlength="15">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductCode" class="bmd-label-floating">Vendedor</label>
										<input type="text" required name="vendedor" pattern="[a-zA-Z0-9]{1,25}" class="form-control" id="ProductCode" maxlength="25">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductName" class="bmd-label-floating">Crédito</label>
										<input type="num" required name="credito" pattern="[a-zA-Z0-9 ]{1,30}" class="form-control" id="ProductName" maxlength="30">
									</div>
								</div>
							</div>
						</div>
