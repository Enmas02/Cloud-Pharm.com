...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="../php/AgregarProducto.php" method="POST" class="form-neon" autocomplete="off">
					<fieldset>
							...
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text" required name="concentracion" pattern="[a-zA-Z0-9 ]{1,30}" class="form-control" id="ProductName" maxlength="30">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProductBrand" class="bmd-label-floating">Fabricante</label>
										<input type="text" required name="fabricante" pattern="[a-zA-Z0-9]{1,25}" class="form-control" id="ProductBrand" maxlength="25">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProductModel" class="bmd-label-floating">Presentación Disponible</label>
										<input type="text" required name="presentacion" pattern="[a-zA-z0-9 ]{1,20}" class="form-control" id="ProductModel" maxlength="20">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="ProducPrice" class="bmd-label-floating">Precio</label>
										<input type="num" required name="precio" pattern="[0-9.]{1,15}" class="form-control" id="ProducPrice" maxlength="15">
									</div>
								</div>
							</div>
						</div>
					...
					<p class="text-center" style="margin-top: 40px;">
						...
						&nbsp; &nbsp;
						<button type="submit" name="guardar" class="btn btn-success"><i class="far fa-save"></i> &nbsp; Guardar</button>
					</p>
				</form>
			</div>	
