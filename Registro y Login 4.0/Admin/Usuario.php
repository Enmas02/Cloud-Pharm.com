		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="Usuario.php"><i class="fas fa-user-plus fa-fw"></i> &nbsp; Nuevo Usuario</a>
					</li>
					<li>
			...
			<!-- Content -->
			<div class="container-fluid">
				<form action="../php/AgregarUsuario.php" method="POST" class="form-neon" autocomplete="off">
					<fieldset>
						<legend><i class="fas fa-user-plus fa-fw"></i> &nbsp; Nuevo Usuario</legend>
						<div class="container-fluid">
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="UserName" class="bmd-label-floating">Nombre</label>
										<input type="text" required name="nombre" pattern="[a-zA-Z]{1,15}" class="form-control" id="UserName" maxlength="15">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="Email" class="bmd-label-floating">Correo</label>
										<input type="email" required name="correo" class="form-control" id="Email" maxlength="50">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="Password1" class="bmd-label-floating">Contraseña</label>
										<input type="password" required name="clave" onkeyup="testPasswor(this.value);" class="form-control" id="Password1" maxlength="50">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="Password2" class="bmd-label-floating">Confirmar Contraseña</label>
										<input type="password" required class="form-control" name="confirmar" id="Password2" maxlength="50">
									</div>
								</div>
								<div class="col-12">
									<div class="form-group">
										<label for="AdminDNI" class="bmd-label-floating">Codigo</label>
										<input type="text" name="codigo" class="form-control" id="AdminDNI" maxlength="29">
										...
										<section id="Images" class="images-cards">
												<div class="row">
													<div class="col-xl-2 col-lg-2 col-md-3 col-sm-4 col-xs-12" id="add-photo-container">
														...
														<input type="file" multiple id="add-new-photo" name="imagen">
													</div>
												</div>
										</section>
									</div>
