		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="Cliente.php"><i class="fas fa-plus"></i> &nbsp; Nuevo Cliente</a>
					</li>
					<li>
						<a class="active" href="VerClientes.php"><i class="fas fa-tasks"></i> &nbsp; Ver Clientes</a>
					</li>
				</ul>	
			</div>
					...
					<table class="table table-dark table-sm">
						...
						<?php while($filas=mysqli_fetch_array($resultado)){ ?>
							...
							<tr class="text-center" >
									<th><?php echo $filas['Nombre']?></td>
									<td><?php echo $filas['Apellido']?></td>
									<td><?php echo $filas['Direccion']?></td>
									<td><?php echo $filas['Telefono']?></td>
									<td><?php echo $filas['Credito']?></td>
									<td><?php echo $filas['Fecha_Pedido']?></td>
									<td><?php echo $filas['Vendedor']?></td>
									<td><?php echo $filas['Credito']?></td>
								<td>
									<a href="ActualizarClientes.php?id=<?php echo $filas['ID']?>" type="button" class="btn btn-success">
	  									<i class="fas fa-sync-alt"></i>
									</a>
									<a href="../php/EliminarCliente.php?id=<?php echo $filas['ID']?>" type="button" class="btn btn-warning">
				...
				<?php
                  ...
                  ?>
                      <?php
                        ...
                        $sql_limite = "SELECT * FROM clientes LIMIT $empezar_desde, $tamagno_pagina";

                        $result = mysqli_query($mysqli, $query);
                        $num_filas= mysqli_num_rows($result);

                        $result2 = mysqli_query($mysqli, $sql_limite);
                        ...
                        $total_paginas= ceil($num_filas/$tamagno_pagina);
                          ...
                          echo "
                                ...
                                <a  href='?index.php=". $i . "' class='page-link'> << </a>
                          ...
                          if ($pagina == 1) {
                              ...
                              echo "<a href='?index.php=". ($pagina - 1) . "' class='page-link'> < </a>";
                          }
                          ...
                          for($i=1;$i<=$total_paginas; $i++){
                            ...
                            if ($i <= $limax) {
                              ...
                              echo "<a href='?pagina=". $i . "' class='pag-n'>". $i . "</a>  ";
                          ...
                          if ($pagina == $total_paginas) {
                              ...
                              echo "<a href='?pagina=". ($pagina + 1) . "' class=''></a>";
                          }


						  echo "<a href='?pagina=". $total_paginas . " ' class='page-link'> >> </a> ";
