		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="Productos.php"><i class="fas fa-plus"></i> &nbsp; Nuevo Producto</a>
					</li>
					<li>
						<a class="active" href="VerProductos.php"><i class="fas fa-tasks"></i> &nbsp; Ver Productos</a>
					</li>
				</ul>	
			</div>
			...
			if (isset($_GET["pagina"])) {
				...
				if($_GET["pagina"]==1){
				   ...
				   echo "<script>location.href='VerProductos.php'</script>";
			   ...
			   $pagina = 1;
					...
					$sql_limite = "SELECT * FROM medicamentos LIMIT $empezar_desde, $tamagno_pagina";
					...
					<table class="table table-dark table-sm">
						...
						<?php while($filas=mysqli_fetch_array($resultado)){ ?>
							...
							<tr class="text-center" >
								...
								<td><?php echo $filas['concentracion']?></td>
								<td><?php echo $filas['fabricante']?></td>
								<td><?php echo $filas['presentacion_disponible']?></td>
								<td><?php echo $filas['precio']?></td>
								<td>
									<a href="ActualizarProductos.php?id=<?php echo $filas['ID']?>" type="button" class="btn btn-success">
	  									<i class="fas fa-sync-alt"></i>
									</a>
									<a href="../php/EliminarProducto.php?id=<?php echo $filas['ID']?>" type="button" class="btn btn-warning">
