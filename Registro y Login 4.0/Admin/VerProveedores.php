		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="Proveedor.php"><i class="fas fa-plus"></i> &nbsp; Nuevo Proveedor</a>
					</li>
					<li>
						<a class="active" href="VerProveedores.php"><i class="fas fa-tasks"></i> &nbsp; Ver Proveedores</a>
					</li>
				</ul>	
			</div>
			...
			if (isset($_GET["pagina"])) {
				...
				if($_GET["pagina"]==1){
				   ...
				   echo "<script>location.href='VerProveedores.php'</script>";
			   ...
			   $pagina = 1;
					...
					$sql_limite = "SELECT * FROM proveedores LIMIT $empezar_desde, $tamagno_pagina";
					...
					<table class="table table-dark table-sm">
						...
						<?php while($filas=mysqli_fetch_array($resultado)){ ?>
							...
							<tr class="text-center" >
								...
								<td>
									<a href="ActualizarProveedores.php?id=<?php echo $filas['ID']?>" type="button" class="btn btn-success">
	  									<i class="fas fa-sync-alt"></i>
									</a>
									<a href="../php/EliminarProveedor.php?id=<?php echo $filas['ID']?>" type="button" class="btn btn-warning">
