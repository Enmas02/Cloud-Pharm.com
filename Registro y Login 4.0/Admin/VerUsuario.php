		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a href="Usuario.php"><i class="fas fa-user-plus fa-fw"></i> &nbsp; Nuevo Usuario</a>
					</li>
					<li>
						<a class="active" href="VerUsuario.php"><i class="fas fa-users fa-fw"></i> &nbsp; Ver Usuarios</a>
					</li>
				</ul>	
			</div>
			...
			if (isset($_GET["pagina"])) {
				...
				if($_GET["pagina"]==1){
				   ...
				   echo "<script>location.href='VerUsuario.php'</script>";
			   ...
			   $pagina = 1;
					...
					$sql_limite = "SELECT * FROM registro LIMIT $empezar_desde, $tamagno_pagina";
					...
					<table class="table table-dark table-sm">
						...
						<tbody>
							...
							<tr class="text-center" >
								...
								<td>
									<a href="ActualizarUsuario.php?id=<?php echo $filas['ID']?>" type="button" class="btn btn-success">
	  									<i class="fas fa-sync-alt"></i>
									</a>
									<a href="../php/EliminarUsuario.php?id=<?php echo $filas['ID']?>" type="button" class="btn btn-warning">
